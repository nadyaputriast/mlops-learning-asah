...
# start=10, stop=1000, num=5, dtype=int
# range = 1000 - 10 = 990
# steps = 990 / (5 - 1) = 247.5
# values = [10, 10+247.5, 10+2*247.5, 10+3*247.5, 10+4*247.5] = [10, 257.5, 505.0, 752.5, 1000] (bulatkan ke bawah)
n_estimators_range = np.linspace(10, 1000, 5, dtype=int)  # 5 evenly spaced values

# start=1, stop=50, num=5, dtype=int
# range = 50 - 1 = 49
# steps = 49 / (5 - 1) = 12.25
# values = [1, 1+12.25, 1+2*12.25, 1+3*12.25, 1+4*12.25] = [1, 13.25, 25.5, 37.75, 50] (bulatkan ke bawah)
